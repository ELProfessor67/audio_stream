...
export const auth = (func) => async (req) => {
    try {
        ...
        const djList = ['/playlist','/filter','/temp-playlist','/welcome-tone','/ending-tone','/song','/filter','/dashboard','/schedule','/dj-forms/volunteer','/dj-forms/executive','/dj-forms/status','dj-forms/all','dj-forms/approve','dj-forms/disapprove','/dj-forms/contract']
