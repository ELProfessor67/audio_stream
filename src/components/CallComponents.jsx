...
export default function CallComponents({open,onClose,children,name,setName}){
	return(
		<div className={`absolute top-0 left-0 right-0 bottom-0 bg-black/5 ${open ? '': 'hidden'}`}>
			<div className="max-w-[20rem] h-[22rem] mx-auto mt-20 bg-[#2f3237] shadow-md p-4 rounded-md flex flex-col">
				...
				<div className="body py-4 flex-1 overflow-auto relative" style={{flex: 'none', height: '18rem',overflowY: 'auto'}}>
					{children}
				</div>
			</div>
		</div>
